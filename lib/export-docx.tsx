...
function markdownToDocxParagraphs(markdown: string): string {
  ...
  for (const line of lines) {
    ...
    // List items
      ...
      paragraphs += `<w:p><w:pPr><w:ind w:left="720"/></w:pPr><w:r><w:t>• ${text}</w:t></w:r></w:p>`
    }
    // Bold text handling
...
<w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:body>
    ...
    <w:p><w:r><w:rPr><w:i/><w:color w:val="666666"/></w:rPr><w:t>Generated by Heroic AI Studio on ${escapeXml(data.createdAt)}</w:t></w:r></w:p>
    <w:sectPr>
